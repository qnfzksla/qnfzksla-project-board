...
import com.qnfzksla.qnfzkslaprojectboard.service.PaginationService;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view] [GET] 게시글 리스트 (게시판) 페이지 - 검색어 와 함께 호출")
    @Test
    ...
    @Test
    public  void givenNothing_whenRequestingArticleSearchView_then() throws Exception {
    ...
    @Test
    public  void givenNothing_whenRequestingArticleHashtagSearchView_then() throws Exception {
